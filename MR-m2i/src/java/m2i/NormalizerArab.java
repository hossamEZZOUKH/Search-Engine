...
public  class NormalizerArab {
     ...
     * @param input String
     */
    public NormalizerArab(String input){
        this.input=input;
    ...
    public static void main(String[] args) {
        String test = "كَلَّا لَا تُطِعْهُ  208  وَاسْجُدْ وَاقْتَرِبْ\" ۩";
        System.out.println("Before: "+test);
        test=new NormalizerArab(test).getOutput();
